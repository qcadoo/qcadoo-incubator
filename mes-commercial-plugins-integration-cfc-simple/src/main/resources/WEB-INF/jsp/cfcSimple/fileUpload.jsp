...
%>
<script type="text/javascript" src="${pageContext.request.contextPath}/cfcSimple/public/js/jquery.form.js"></script>
...
<script type="text/JavaScript">
	...
	function checkExtension(fileName) {
		...
		for (var i = 0; i < acceptExtensions.length; i++) {
			if (acceptExtensions[i] === fileType) {
				contains = true;
			}
		}
...
<form method="post" action="<%=ctx%>/${submitPage}" enctype="multipart/form-data" id="form" style="text-align: left">
	...
	<div style="margin-top: 5px; margin-bottom: 20px; margin-left: 10px;">
		<input type="file" name="file" size="40" onChange="checkExtension(this.value);"/>
	</div>
