 ...
 * ***************************************************************************
 */
package com.qcadoo.mes.integration.sfcSimple;
...
@Controller
public class IntegrationSubiektController extends IntegrationController {

    @Autowired
    @Qualifier("subiektIntegrationPerformer")
    private IntegrationPerformer integrationPerformer;

    @RequestMapping(value = SfcSimpleConstants.PLUGIN_IDENTIFIER + "/uploadPage", method = RequestMethod.GET)
    public final ModelAndView getSubiektUploadPageView(final Locale locale) {
        return getUploadPageView(locale);
    }

    @RequestMapping(value = SfcSimpleConstants.PLUGIN_IDENTIFIER + "/performUpload", method = RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value = SfcSimpleConstants.PLUGIN_IDENTIFIER + "/infoPage", method = RequestMethod.GET)
    ...
    protected final IntegrationPerformer getIntegrationPerformer() {
        return integrationPerformer;
    }

    protected final List<String> getAcceptedFileExtension() {
        return Collections.<String> singletonList("epp");
    }
}
